                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                ...
                                $view =  "SELECT * FROM prescription WHERE doctor_id = $id";
                                $viewPrescription = mysqli_query($conn,$view);
                                // output data of each row
                                while($row = mysqli_fetch_assoc($viewPrescription)) {
                                ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo 'patientPrescriptionDetails.php?id='.$row["id"]; ?>" type="button" class="btn btn-xs btn-info margin-bottom-5"><i class="fa fa-eye"></i> View</a>
                                    </td>
                                </tr>
                                    <?php
                                }
