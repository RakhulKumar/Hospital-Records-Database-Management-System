    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="caption font-dark" style="margin-top: 6px;font-size: 20px;">
                ...
                <span class="caption-subject bold uppercase">Add Doctor Time</span>
                <small>Add Doctor Time</small>
            </div>
...
<!--                                                    </div>-->
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-2">
                                                                <input type="text"  name="working_time1" class="table-group-action-input form-controlm" placeholder="Working Time" required/>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <input type="text"  name="working_time2" class="table-group-action-input form-controlm" placeholder="Working Time" required/>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <input type="text"  name="working_time3" class="table-group-action-input form-controlm" placeholder="Working Time" required/>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <input type="text"  name="working_time4" class="table-group-action-input form-controlm" placeholder="Working Time" required/>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <input type="text"  name="working_time5" class="table-group-action-input form-controlm" placeholder="Working Time" required/>
                                                            </div>
                                                    </div>
                                                            <span style="padding-left: 18%;" class="text-info">*Please give different timings for each doctor</span>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-actions noborder">
                                                            ...
                                                            <button type="submit" class="btn thm-btn btn-flat"
                                                                    data-loading-text="Please wait..." name="addTime">Submit Now</button>
                                                        </div>
                                                        <?php
