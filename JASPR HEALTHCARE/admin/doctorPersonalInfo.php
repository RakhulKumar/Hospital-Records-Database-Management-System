                    ...
                    <div class="form-horizontal form-row-seperated">
                        <div class="portlet">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-shopping-cart"></i>Doctor Information
                                </div>
                            ...
                            <div class="portlet-body">
                                <div class="tabbable-bordered">
                                    <ul class="nav nav-tabs">
                                        <li class="active">
                                            <a href="#tab_general" data-toggle="tab">Doctor Information </a>
                                        </li>
                                        ...
                                        <div class="tab-pane active" id="tab_general">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    {
                                                    $email = $_GET['value'];
                                                    $view =  "SELECT * FROM doctors WHERE email = '$email'";
                                                    ...
                                                    ?>
                                                        <div class="col-md-4">
                                                                ...
                                                                <form role="form" name="updateDoctorImage" method="post"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="updatedImage">
                                                                            <img width="250" height="200" name="doctor_image" src=" <?php echo 'uploads/doctor_images/'.$row['doctor_image']; ?>"
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <br/>
                                                                    <div class="responseDoctorEdit"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <div class="col-md-8">
                                                        <div class="portlet light bordered">
                                                            <div class="portlet-title">
                                                                <div class="caption font-red-sunglo">
                                                                    <span class="caption-subject bold uppercase">Update Doctor Information</span>
                                                                </div>
                                                            ...
                                                            <form id="editProductForm" method="post"
                                                                ...
                                                                <div class="form-actions noborder">
                                                                    <input type="hidden" value="<?php echo $row['id']; ?>" name="doctor_id">
                                                                    <button type="submit"  name="updatePersonal"
                                                                       data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>"
