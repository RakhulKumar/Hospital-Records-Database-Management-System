                  ...
                  <div class="col-md-6">
                      ...
                      <div class="portlet light bordered">
                          <div class="portlet-title">
                              <div class="caption font-red-sunglo">Add Service
                              </div>

                          </div>
                          <div class="portlet-body form">
                              <form role="form" id="addServiceForm" method="post" action="admin_php/services.php" enctype="multipart/form-data">
                                  <div class="form-body">
                                      ...
                                      <div class="form-group form-md-line-input has-info">
                                          <div class="input-group">
                                              <label class="form_control_1">Service Image:
                                                  ...
                                                  <input type="file"  name="service_image" class="table-group-action-input form-controlm" required/>
                                      ...
                                      <div class="form-actions noborder">
                                         <button type="submit" name="addService"
                                                  ...
                                                  class="btn blue"><i class="fa fa-arrow-circle-right"></i> Add
                                          </button>
                                        <!--  <a href="services.php" type="submit" class="btn blue ">
                                  ...
                                  if(isset($_GET['success']))
                                  {
                                      ...
                                      <div class="alert-success" style="height:34px;">
                                         <p class="error_message" style="text-align: center;">
                                             <?php echo 'New Service is added successfully !'; ?>
                                         </p>
                                      </div>
                                  ...
                                  elseif(isset($_GET['error']))
                                  {
                                      ...
                                      <div class="alert-danger" style="height:34px;">
                                          <p class="error_message" style="text-align: center;">
                                              <?php echo 'There is an error in adding your service !'; ?>
                                          </p>
                                      </div>
                                  <?php
                                  }
