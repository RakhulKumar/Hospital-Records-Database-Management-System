                  ...
                  <div class="col-md-6">
                      ...
                      <div class="portlet light bordered">
                          <div class="portlet-title">
                              <div class="caption font-red-sunglo"><span>Review Details</span>
                              </div>
                          ...
                          <div class="portlet-body form">
                              ...
                              $view =  "SELECT * FROM blog_details WHERE id = $id";
                              $reviewDetailList = mysqli_query($conn,$view);
                              // output data of each row
                              while($row = mysqli_fetch_assoc($reviewDetailList)) {
                              ?>
                                  <div class="form-body">
                                      ...
                                      <div class="form-actions noborder">
                                          <a href="<?php echo 'blogDetails.php?id='.$row['blog_id'] ;?>" type="submit" id="button_update_department"
