              ...
              <div class="page-bar">
                  ...
                  <div class="page-toolbar">
                      <div class="btn-group pull-right">
                          <a href="prescription.php" type="button" class="btn green btn-sm btn-outline"> <i class="fa fa-long-arrow-left"></i> Back
                                  ...
                                  <div class="form-body">
                                      ...
                                      <div class="form-group form-md-line-input has-info">
                                          <div class="input-group">
                                              ...
                                              <input class="form-control datepicker" type="text"  placeholder="MM/DD/Year" value="<?php echo $row['date']; ?>" name="appointment_date" required>
                                      ...
                                      <div class="form-group form-md-line-input has-info">
                                          <div class="input-group">
                                              ...
                                              <input type="text" class="form-control timepicker" placeholder="Time"
                                                     value="<?php echo date('H:i a',strtotime($row['time'])); ?>" name="appointment_time" required>
                                      ...
                                      <div class="form-group form-md-line-input has-info">
                                          <div class="input-group">
                                              ...
                                              <input type="text" value="<?php echo ucwords($row['prescription']); ?>" name="prescription"  class="form-control" placeholder="Prescription" required>
                                      ...
                                      <div class="form-group form-md-line-input has-info">
                                          <div class="input-group">
                                              ...
                                              <input type="text" value="<?php echo $row['quantity']; ?>" name="quantity"  class="form-control" placeholder="Prescription" required>
                                      ...
                                      <div class="form-group form-md-line-input has-info">
                                          <div class="input-group">
                                              ...
                                              <input type="text" value="<?php echo ucwords($row['time_to_take']); ?>" name="time_to_take"  class="form-control" placeholder="Prescription" required>
                                      ...
                                      <div class="form-actions noborder">
                                          <a href="prescription.php" type="submit"
                                             data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>"
                                             class="btn blue"><i class="fa fa-arrow-circle-right"></i> Back </a>
